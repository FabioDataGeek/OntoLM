...
for i in (train_index):
    with open(f"/usrvol/data/ISABIAL/binary/statements/train.statements.jsonl", 'a') as fout:
        stm = statements[i]
...
counter = 0
for i in (dev_index):
    with open(f"/usrvol/data/ISABIAL/binary/statements/dev.statements.jsonl", 'a') as fout:
        stm = statements[i]
...
counter = 0
for i in (test_index):
    with open(f"/usrvol/data/ISABIAL/binary/statements/test.statements.jsonl", 'a') as fout:
        stm = statements[i]
...
with open('/usrvol/data/ISABIAL/binary/graphs/train.pickle', 'wb') as f:
...
for i in (dev_index):
    graph_list.append(graphs[i])
with open('/usrvol/data/ISABIAL/binary/graphs/dev.pickle', 'wb') as f:
    pkl.dump(graph_list, f)
...
for i in (test_index):
    graph_list.append(graphs[i])
with open('/usrvol/data/ISABIAL/binary/graphs/test.pickle', 'wb') as f:
    pkl.dump(graph_list, f)
