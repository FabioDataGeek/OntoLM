...
with open('/usrvol/data/graph_statements/graph_statements.pickle', 'rb') as f:
    graphs =  pkl.load(f)

with open('/usrvol/data/statements.pickle', 'rb') as f:
...
for i in (train_index):
    with open(f"/usrvol/data/ISABIAL/statements/train.statements.jsonl", 'a') as fout:
        stm = statements[i]
...
counter = 0
for i in (dev_index):
    with open(f"/usrvol/data/ISABIAL/statements/dev.statements.jsonl", 'a') as fout:
        stm = statements[i]
...
counter = 0
for i in (test_index):
    with open(f"/usrvol/data/ISABIAL/statements/test.statements.jsonl", 'a') as fout:
        stm = statements[i]
...
with open('/usrvol/data/ISABIAL/graphs/train.pickle', 'wb') as f:
...
for i in (dev_index):
    graph_list.append(graphs[i])
with open('/usrvol/data/ISABIAL/graphs/dev.pickle', 'wb') as f:
    pkl.dump(graph_list, f)
...
for i in (test_index):
    graph_list.append(graphs[i])
with open('/usrvol/data/ISABIAL/graphs/test.pickle', 'wb') as f:
    pkl.dump(graph_list, f)
