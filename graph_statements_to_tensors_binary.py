...
for file in files:
    with open(f"/usrvol/data/ISABIAL/binary/graphs/{file}.pickle", 'rb') as f:
    ...
    with open(f"/usrvol/data/binary/graph_statements_tensors/graph_statements{file}.pickle", 'wb') as f:
