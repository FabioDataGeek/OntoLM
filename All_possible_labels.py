...
final_labels = {}
annotation_path = '/usrvol/data/annotations/annotations_dict_filtered.pickle'
labels_obtained_path = '/usrvol/data/labels'
...
with open('/usrvol/data/final_labels.pickle', 'wb') as f:
